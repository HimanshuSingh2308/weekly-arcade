...
(function () {
  ...
  class GUIManager {
    ...
    _buildMPMenu() {
      ...
      const privateBtn = this._createSecondaryButton('CREATE ROOM', '165px', '44px', btnRow2);
      privateBtn.onPointerClickObservable.add(() => { this._fire('click'); this._fire('mpCreatePrivate'); });

      var sp1 = new GUI.Rectangle(); sp1.width = '8px'; sp1.height = '1px'; sp1.thickness = 0; sp1.background = 'transparent'; btnRow2.addControl(sp1);

      const joinBtn = this._createSecondaryButton('JOIN CODE', '165px', '44px', btnRow2);
