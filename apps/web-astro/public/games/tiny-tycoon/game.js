  ...
  function getDecoVisuals() {
    return {
      ...
      art_wall: {
        html: '<div class="shop-decor decor-art"><div class="art-frame"><div class="brew-scene"><div class="brew-pourover"></div><div class="brew-stream"></div><div class="brew-mug"></div><div class="brew-steam s1"></div><div class="brew-steam s2"></div></div></div></div>',
