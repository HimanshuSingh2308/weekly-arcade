...
(function () {
  ...
  const CSS = `
    .gh {
      ...
      padding-top: max(0.55rem, env(safe-area-inset-top), var(--safe-area-inset-top, 0px));
      padding-left: max(0.75rem, env(safe-area-inset-left), var(--safe-area-inset-left, 0px));
      padding-right: max(0.75rem, env(safe-area-inset-right), var(--safe-area-inset-right, 0px));
      display: flex;
